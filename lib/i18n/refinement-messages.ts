...
export const refinementMessages = {
  ...
  'scale.behaviour.prompt': [
    'How often did this describe your work in that project or task?',
    '在該專案或任務中，這種做法出現得有多頻繁？',
  ],
  ...
  'question.B01.prompt': [
    'Before proposing a solution, how often did you check what was happening in the actual setting?',
    '提出方案前，你有多常確認實際場景中發生的情況？',
  ],
  'question.B02.prompt': [
    'How often did you deliver your agreed part of the work by the time your teammates needed it?',
    '你有多常在隊友需要之前，交付自己答應負責的工作？',
  ],
  'question.B03.prompt': [
    'How often did you change an explanation after noticing what your audience did or did not understand?',
    '發現聽眾理解或不理解某些內容後，你有多常調整解釋方式？',
  ],
  'question.B04.prompt': [
    'Before choosing a solution, how often did you compare alternatives against the requirements?',
    '選定方案前，你有多常根據要求比較不同方案？',
  ],
  'question.B05.prompt': [
    'How often did you make a rough prototype while there was still time to change the design?',
    '在仍有時間修改設計時，你有多常先製作粗略原型？',
  ],
  'question.B06.prompt': [
    'How often did an idea or method from another discipline change the way you approached a task?',
    '其他學科的想法或方法，有多常改變你處理任務的方式？',
  ],
  'question.B07.prompt': [
    'How often did you check an observation, measurement, or user account before deciding which problem to pursue?',
    '決定跟進哪個問題前，你有多常查核觀察、量度或使用者的描述？',
  ],
  'question.B08.prompt': [
    'Before running a test, how often did you specify the question or success criterion it should address?',
    '進行測試前，你有多常先列明它要回答的問題或檢驗的成功準則？',
  ],
  'question.B09.prompt': [
    'How often did you write down the next steps, handovers, and owners before a piece of work began?',
    '開始一項工作前，你有多常寫下接下來的步驟、交接及負責人？',
  ],
  'question.B10.prompt': [
    'When presenting a claim, how often did you show the measurement, test, or source behind it?',
    '提出主張時，你有多常展示背後的量度、測試或資料來源？',
  ],
  'question.B11.prompt': [
    'When a prototype did not work as expected, how often did you check a likely cause before changing the design?',
    '原型不符合預期時，你有多常先檢查可能原因，再修改設計？',
  ],
  'question.B12.prompt': [
    'When teammates disagreed, how often did you help identify the specific decision they needed to resolve?',
    '隊友有分歧時，你有多常協助釐清大家需要解決的具體決定？',
  ],
  'question.B13.prompt': [
    'Before committing to a plan, how often did you record a risk and how the team would respond to it?',
    '落實計劃前，你有多常記錄一項風險及團隊的應對方法？',
  ],
  'question.B14.prompt': [
    'How often did you turn a broad concern into a problem statement with a clear scope?',
    '你有多常把廣泛的關注轉化為範圍清晰的問題陳述？',
  ],
  'question.B15.prompt': [
    'When explaining a solution, how often did you state a limitation or a trade-off alongside its benefits?',
    '解釋方案時，你有多常在介紹效益的同時說明限制或取捨？',
  ],
