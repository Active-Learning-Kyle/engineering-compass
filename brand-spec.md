# Engineering Compass visual specification

## Brand status

Engineering Compass is a standalone formative engineering self-reflection product. It uses an HKU-inspired academic green/white visual language but does not reproduce or claim to be an official HKU brand identity. No official HKU crest or faculty logo is used.
