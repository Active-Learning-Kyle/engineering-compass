...
| Speed reflection             | Gently nudge unusually fast response patterns                                  | Implemented as a blocking reflection check after repeated sub-4-second responses                                | Keep                                   | Recalibrate only if pilot evidence suggests a change                                                          |
